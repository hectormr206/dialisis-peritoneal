  ...
  return (
    <Layout title='Diálisis peritoneal' description={description}>
      ...
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>18</span> Poner <strong>2</strong> push de Except en la línea de transferencia (Donde es la desconexión entre área verde y azul) <strong>y colocar la gasa</strong>
          </li>
        </ul>
      </Card>
      <Card>
      ...
      <Card>
        <ul>
          <li>
            <span>19</span> Sacar la bolsa con agua díalizante, <strong>cuidando de no tocar la parte exterior</strong>:
            <ul>
              <li>
                <input type='checkbox' /> <span>19.1</span> Se acomoda sobre el lado limpio de la mesa de trabajo, con el lado de inyección de medicamento hacia nosotros
              </li>
              <li>
                <input type='checkbox' /> <span>19.2</span> Jalamos sitio de inyección y sitio de salida de la bolsa de solución
              </li>
              <li>
                <input type='checkbox' /> <span>19.3</span> Quitamos los sellos
              </li>
              <li>
                <input type='checkbox' /> <span>19.4</span> Despegamos el conector "Y", una parte pequeña de las líneas (Mangueras) y lo colocamos debajo de la bolsa
              </li>
              <li>
                <input type='checkbox' /> <span>19.5</span> Empezamos a despegar las líneas de ingreso y egreso (Mangueras)
              </li>
              <li>
                <input type='checkbox' /> <span>19.6</span> Tomamos la bolsa de drenado y la enrollamos colocándola debajo de la bolsa
              </li>
              <li>
                <input type='checkbox' /> <span>19.7</span> Se pinza la línea de ingreso cerca de la "Y" (Manguera blanca)
              </li>
              <li>
                <input type='checkbox' /> <span>19.8</span> Si fuera necesario, se inyecta el medicamento en el sitio de inyección
              </li>
              <li>
                <span>19.9</span> Si es medicamento en polvo:
                <ul>
                  <li>
                    <input type='checkbox' /> <span>19.9.1</span> Utilizar 5ml de la solución dializante y inyectarlos en frasco pequeño o 10 ml en frasco grande (Para ambos casos usamos las jeringas de 10 ml)
                  </li>
                  <li>
                    <input type='checkbox' /> <span>19.9.2</span> Con mucho cuidado de no perforar la bolsa de solución se saca el líquido de la bolsa de diálisis para prepararlo
                  </li>
                  <li>
                    <input type='checkbox' /> <span>19.9.3</span> Sin sacar la jeringa del frasco, una vez que se le haya introducido el líquido, se agita de un lado hacia otro y se extrae el medicamento, posteriormente se inyecta a la bolsa de diálisis
                  </li>
                  <li>
                    <input type='checkbox' /> <span>19.9.4</span> Si la concentración de la heparina es de 5000 unidades, solo se inyectaran 40 unidades a la bolsa
                  </li>
                </ul>
              </li>
            </ul>
      ...
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>20</span> Tomamos la línea de la bolsa colocándola entre el dedo índice y medio en el lugar indicado para sujetar correctamente
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>21</span> Con la gasa que colocamos para cubrir, la deslizamos limpiando en forma circular hasta sujetar solo el conector azul
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>22</span> Tomamos con nuestra mano el conector verde de la línea y lo ponemos entre el pulgar y el dedo índice
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>23</span> Seguimos limpiando con la gasa la demás parte de la línea
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>24</span> Aflojamos tapón de la bolsa de diálisis
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>25</span> Aflojamos tapón del catéter del paciente
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>26</span> Quitamos tapón de la bolsa y ponemos <strong>dos push</strong> de Except
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>27</span> Quitamos tapón del catéter y ponemos <strong>dos push</strong> de Except
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>28</span> Conectamos
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>29</span> Colgamos la bolsa
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>30</span> Despegamos la bolsa de drenado y bajamos la bolsa a la charola. La bolsa de drenado debe tener una altura menor a la del paciente
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>31</span> Abrimos línea <strong>(Las dos flechitas rojas quedan separadas)</strong>
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>32</span> Cubrimos la línea con la compresa
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>33</span> Anotamos hora de apertura de línea en el cuaderno
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>34</span> El líquido debe empezar a salir <strong>(Si no sale cambiamos la postura del paciente, el líquido debe tardar en salir de 15 a 25 minutos, si tarda más algo puede estar mal)</strong>
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>35</span> Cerramos línea de transferencia <strong>(Las dos marquitas rojas quedan juntas)</strong>
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>36</span> Anotamos hora de cierre de línea en el cuaderno
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>37</span> Sostener la "Y" y rompemos el segmento de ruptura de la línea de ingreso <strong>(Manguera blanca)</strong>
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>38</span> Quitamos la pinza, esperamos 1 segundos y pinzamos la linea de egreso <strong>(Manguera verde)</strong> hasta que salgan todas las burbujas de aire de la línea de ingreso
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>39</span> Abrimos línea para que entre el líquido limpio <strong>(Debe tardar entre 8 y 10 minutos aproximadamente)</strong>
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>40</span> Anotamos hora de apertura de línea en el cuaderno
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>41</span> Cerramos línea de transferencia <strong>(Las dos marquitas rojas quedan juntas)</strong>
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>42</span> Anotamos hora de cierre de línea en el cuaderno
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>43</span> Cerramos obturador inviolable
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>44</span> Bajamos la bolsa del tripié
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>45</span> Rompemos el cople de ruptura <strong>y colocamos la jeringa con el cloro en la entrada que quedó después de romper el cople de ruptura, sin inyectarla aun</strong>
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>46</span> Despinzamos la línea de egreso <strong>(Manguera verde)</strong> y pinzamos la línea de ingreso <strong>(Manguera blanca)</strong>
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>47</span> Inyectamos los 10 ml de cloro en la bolsa de diálisis con el agua sucia y pinzamos la línea de egreso en la parte baja
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>48</span> Hacemos un nudo en ambas líneas y despinzamos la línea de egreso
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>49</span> <strong>Se revisa la bolsa de egreso y anotamos en el cuaderno</strong>
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>50</span> Tiramos bolsa. <strong>Se deja 15 minutos, posteriormente se desecha en la cañería</strong>
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>51</span> Se guarda el catéter en el fajero
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>52</span> <strong>Doblamos la compresa y la guardamos. Recordar que siempre se utiliza la misma compresa</strong>
          </li>
        </ul>
      </Card>
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>53</span> Con una de las compresas impregnada de cloro limpiamos la báscula, tina de plástico <strong>(La que tenía la bolsa de agua sucia)</strong> y la ponemos en su lugar
          </li>
        </ul>
      </Card>
      <Card>
      ...
      <Card>
        <ul>
          <li>
            <input type='checkbox' /> <span>55</span> Llevamos la bolsa de egreso al drenaje para desechar su contenido con la ayuda de unas tijeras
          </li>
        </ul>
      </Card>
    </Layout>
